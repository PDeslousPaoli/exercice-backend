...
const votes_deputes_model_1 = require("../../infrastructure/models/votes-deputes.model");
const votes_deputes_1 = require("../DTO/votes-deputes");
let DepsearchResolver = class DepsearchResolver {
    constructor(votesDeputeService, depsearchService) {
...
exports.DepsearchResolver = DepsearchResolver = __decorate([
    ...
    __param(0, (0, common_1.Inject)("IVotesDeputesService")),
    __metadata("design:paramtypes", [votes_deputes_service_1.VotesDeputesService,
